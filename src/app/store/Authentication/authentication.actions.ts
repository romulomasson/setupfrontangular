...
// login action
export const login = createAction('[Authentication] Login', props<{ usuario: string, password: string }>());
export const loginSuccess = createAction('[Authentication] Login Success', props<{ user: any, claims: any }>());
